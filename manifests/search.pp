...
class kopano::search (
  ...
  String $index_path                        = '/var/lib/kopano/search/',
  Integer $limit_results		                = 1000,
  String $server_bind_name                  = 'file:///var/run/kopano/search.sock',
  String $ssl_private_key_file              = '/etc/kopano/search/privkey.pem',
  String $ssl_certificate_file              = '/etc/kopano/search/cert.pem',
  Enum['syslog','file'] $log_method         = 'file',
  String $log_file                          = '/var/log/kopano/search.log',
