...
class kopano::gateway (
  ...
  String $ssl_private_key_file	              = '/etc/kopano/gateway/privkey.pem',
  String $ssl_certificate_file	              = '/etc/kopano/gateway/cert.pem',
  ...
  String $log_file	                          = '/var/log/kopano/gateway.log',
