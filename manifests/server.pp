...
class kopano::server (
  ...
  String               $server_pipe_name             = '/var/run/kopano/server.sock',
  String               $server_pipe_priority         = '/var/run/kopano/prio.sock',
  ...
  String               $pid_file                     = '/var/run/kopano/server.pid',
  String               $running_path                 = '/var/lib/kopano',
  ...
  String $log_file                                   = '/var/log/kopano/server.log',
  Integer $log_level                                 = 3,
  ...
  String               $audit_log_file               = '/var/log/kopano/audit.log',
  ...
  String               $attachment_path              = '/var/lib/kopano/attachments',
  ...
  String               $server_ssl_key_file      	   = '/etc/kopano/ssl/server.pem',
  String               $server_ssl_key_pass	         = 'replace-with-server-cert-password',
  String               $server_ssl_ca_file	         = '/etc/kopano/ssl/cacert.pem',
  ...
  String               $sslkeys_path		             = '/etc/kopano/sslkeys',
  Integer $threads				                           = 8,
  ...
  String               $user_plugin_config	         = '/etc/kopano/ldap.cfg',
  String               $plugin_path		               = '/usr/lib64/kopano',
  String               $createuser_script		         =	'/etc/kopano/userscripts/createuser',
  String               $deleteuser_script		         =	'/etc/kopano/userscripts/deleteuser',
  String               $creategroup_script		       =	'/etc/kopano/userscripts/creategroup',
  String               $deletegroup_script		       =	'/etc/kopano/userscripts/deletegroup',
  String               $createcompany_script	       =	'/etc/kopano/userscripts/createcompany',
  String               $deletecompany_script	       =	'/etc/kopano/userscripts/deletecompany',
  ...
  String               $client_update_path           = '/var/lib/kopano/client',
  Integer[0,2] $client_update_log_level              = 1,
  String               $client_update_log_path       = '/var/log/kopano/autoupdate',
