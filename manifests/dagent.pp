...
class kopano::dagent (
  ...
  String $log_file                           = '/var/log/kopano/dagent.log',
  Enum['0','1'] $log_timestamp	             = '1',
  Enum['yes','no'] $log_raw_message          = 'no',
  String $log_raw_message_path               = '/tmp',
  String $tmp_path                           = '/tmp',
  ...
  String $plugin_manager_path                = '/usr/share/kopano-dagent/python',
  String $plugin_path                        = '/var/lib/kopano/dagent/plugins',
